...
export type IsPlainObject<T> = T extends Primitive ? false : T extends Function
                                                             ? false
    ...
    [K in keyof T | keyof U]: K extends keyof U ? K extends keyof T
                                                  ? IsPlainObject<T[K]> extends true
                                                    ? IsPlainObject<U[K]> extends true
                                                      ...
                                                      : U[K]
                                                    : U[K]
                                                  : U[K] : K extends keyof T ? T[K] : never;
};


export const isPlainObject = (value: unknown): value is Record<string, unknown> => Object.prototype.toString.call(
    value) === '[object Object]';
